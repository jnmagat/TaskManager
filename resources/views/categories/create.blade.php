...
<div class="max-w-md mx-auto p-6 bg-gray-900 rounded shadow-lg text-gray-200">
    ...
    {{-- Link back to the category list --}}
    <div class="mb-4">
        <a href="{{ route('categories.index') }}" class="text-gray-400 hover:text-gray-200 flex items-center">
    ...
    {{-- Page title --}}
    <h1 class="text-2xl font-bold mb-6 text-indigo-400">Create Category</h1>
